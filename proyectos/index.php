                                ...
                                if ($num_rows > 0) {
                                    while ($row = mysqli_fetch_array($resultEstatus)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>' . $row['nombre'] . '</td>
                                            <td>
                                                <a class="btn btn-danger btn-circle btn-sm bajaProyecto " data-idproyecto="' . $row['id_proyecto'] . '" data-tipoproyecto="' . $row['tipo_proyecto'] . '" data-nombreproyecto="' . $row['nombre_proyecto'] . '" data-fechaentrega="' . $row['fecha_entrega'] . '" data-idestatus="' . $row['id_estatus'] . '" data-idcolaborador="' . $row['id_colaborador'] . '" data-toggle="tooltip"
                                                data-placement="right" data-target="#myModal" title="Eliminar Proyecto">
                                                    <i class="fa fa-trash-o"></i>
                         
                                                
                                                <a href="../modificar-estatus" class="btn btn-primary btn-circle btn-sm"  data-idproyecto="' . $row['id_proyecto'] . '" data-toggle="tooltip"
                                                data-placement="right" data-target="#ModalModificar" title="Modificar Proyecto">
                                                    <i class="fa fa-pencil"></i>

                                                    <a href="detalles.php" class="btn btn-primary btn-circle btn-sm"  data-idproyecto="' . $row['id_proyecto'] . '"
                                                data-placement="right" data-toggle="tooltip" data-target="#ModalModificar" title="Detalles del Proyecto">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
