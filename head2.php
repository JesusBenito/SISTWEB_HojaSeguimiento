            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img
                                ...
                                class="hidden-xs">Colaborador</b> </a>
        ...
        <ul class="mini-nav">
            ...
            <li class="selected">
                <div class="sidebarmenu">
                    <!-- Left navbar-header -->
                    <h3 class="menu-title">Bienvenido</h3>
                    <ul class="sidebar-menu">
                        
                        <li><a href="../index2">Proyectos</a></li>
                        <li><a href="../agregarActividad">Registrar Actividad</a></li>
                        <li><a href="../contraseña" >Cambiar Contraseña</a></li>

                            
                        <li><a href="../logout/index.php">Cerrar Sesion</a></li>
                    </ul>
